# -*- coding: utf-8 -*-
"""Noisy_Top_K_Mixture_Of_Experts_Inference.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/12JsJM7z8UOFLqGpsr6QXRuncA6aRj6k9
"""
...
labels = [item['label_one_hot'] for item in test_dataset]  # one-hot encoded labels

# Tokenize data
encodings = encode_data(tokenizer, prompts)

# Create dataset
test_set = MCQDataset(encodings, labels)
...
def train_and_validate(model, train_loader, val_loader, epochs=1, log_file_path = "/content/drive/MyDrive/685 Final Project/Models/TopKMoE/training_logs.txt"):
...
import torch.nn.functional as F
def run_inference(model, val_loader,name):
...
output = run_inference(moe_model, val_loader, 'noisyTopK_cf')
